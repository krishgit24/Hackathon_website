          ...
          <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-10">
            ...
            <div className="relative text-center">
              ...
              <button
                ...
                className="group w-1/2 py-5 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 rounded-xl hover:shadow-2xl hover:shadow-cyan-500/50 transition-all"
              >
          ...
          <div className='mt-5'>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center">
                ...
                <div className="text-gray-400 text-sm">Stutents</div>
              </div>
            </div>
          </div>
