...
export default function Footer() {
  return (
    <footer className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative z-10 text-center px-8">
        ...
        <h2 className="text-5xl lg:text-7xl xl:text-8xl bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent font-bold uppercase">
          2025
        </h2>
      </div>
    </footer>
