...
export function Sponsors() {
  const platinumSponsors = [
    { name: 'FRIENDS OF FIGMA', icon: fof, gradient: 'from-cyan-500 to-cyan-700' },
    { name: 'CUROMATES', icon: curomate, gradient: 'from-purple-500 to-purple-700' },
  ];

  return (
    <section id="sponsors" className="relative py-10 px-8 lg:px-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-400 ml-8">
        ...
        <div className="mb-16">
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {platinumSponsors.map((sponsor, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${sponsor.gradient} opacity-0 group-hover:opacity-10 transition-opacity rounded-3xl`}
                />
